...
public class TestBase {
    ...
    public void setUp() {
        ...
        switch (initialProperties.get("browserName")){
            ...
            case "edge":{
                System.setProperty("webdriver.edge.driver", WebDriverHandler.getWindowsEdgeDriverPath(initialProperties.get("os")));
                driver = new EdgeDriver(BrowserHandler.createEdgeOptions());
                break;
            }
        }
